...
if ( isset($mode) && $mode == "delete" ) {
	...
	if ( !(isset($delete)) && !(isset($confirm_delete)) ) {
		...
		print "<form method=post ACTION='$self'><input type=hidden name=p value='$p'><input type=hidden name=mode value='delete'><input type=hidden name=delete value='set'><input type=hidden name=id value=$id><input type=submit value=\"$MRTGMsg[21]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:70px\"></form>";
	...
	} elseif ( isset($delete) && !(isset($confirm_delete)) ) {
		...
		print "<table cellpadding=2 cellspacing=2><tr align=center><td>";
		print "<form method=post ACTION='index.php'><input type=hidden name=p value='$p'><input type=submit value=\"$MRTGMsg[21]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:70px\"></form>";
		print "</td><td><form method=post ACTION='$self'><input type=hidden name=p value='$p'><input type=hidden name=mode value='delete'><input type=hidden name=id value=$id><input type=hidden name=delete value='set'><input type=hidden name=confirm_delete value='set'><input type=submit value=\"$MRTGMsg[22]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:70px\"></form>";
		print "</td></tr></table></td></tr></table></div>";
	} elseif ( isset($delete) && isset($confirm_delete) ) {
		$records = array("id" => $id);
		...
		if ($result) {
			print "<div align=center><table cellpadding=4 cellspacing=2 width=40% bgcolor='#808080'><tr bgcolor='#F0F0F0' align=center><td class=red><br><b>$MRTGMsg[28] <font color='#0000FF'>$id</font> $MRTGMsg[29]</b><br>";
	...
	if ( !(isset($confirm_restore)) ) {
		...
		print "<table cellpadding=2 cellspacing=2><tr align=center><td>";
		print "<form method=post ACTION='delete.php'><input type=hidden name=p value='$p'><input type=hidden name=mode value='restore'><input type=hidden name=confirm_restore value='set'><input type=hidden name=id value=$id><input type=submit value=\"$MRTGMsg[21]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:70px\"></form>";
		print "</td><td><form method=post ACTION='index.php'><input type=hidden name=p value='$p'><input type=submit value=\"$MRTGMsg[22]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:70px\"></form>";
		print "</td></tr></table></td></tr></table></div>";
		...
		if ($result) {
			print "<div align=center><table cellpadding=4 cellspacing=2 width=40% bgcolor='#808080'><tr bgcolor='#F0F0F0' align=center><td class=red><br><b>$MRTGMsg[110] <font color='#0000FF'>$id</font> $MRTGMsg[111]</b><br>";
			print "<form method=post ACTION='index.php'><input type=hidden name=p value='$p'><input type=submit value=\"$MRTGMsg[24]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:100px\"></form>";
			print "</td></tr></table></div>";
		} else {
	...
	if ( !(isset($confirm_trash)) ) {
		...
		print "<table cellpadding=2 cellspacing=2><tr align=center><td>";
		print "<form method=post ACTION='delete.php'><input type=hidden name=p value='$p'><input type=hidden name=confirm_trash value='set'><input type=hidden name=id value=$id><input type=submit value=\"$MRTGMsg[21]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:70px\"></form>";
		print "</td><td><form method=post ACTION='index.php'><input type=hidden name=p value='$p'><input type=submit value=\"$MRTGMsg[22]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:70px\"></form>";
		print "</td></tr></table></td></tr></table></div>";
		...
		if ($result) {
			print "<div align=center><table cellpadding=4 cellspacing=2 width=40% bgcolor='#808080'><tr bgcolor='#F0F0F0' align=center><td class=red><br><b>$MRTGMsg[105] <font color='#0000FF'>$id</font> $MRTGMsg[106]</b><br>";
			print "<form method=post ACTION='index.php'><input type=hidden name=p value='$p'><input type=submit value=\"$MRTGMsg[24]\" style=\"color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:100px\"></form>";
			print "</td></tr></table></div>";
		} else {
			print "<div align=center><table cellpadding=4 cellspacing=2 width=40% bgcolor='#808080'><tr bgcolor='#F0F0F0' align=center><td class=red><br><b>$MRTGMsg[30] $id</b><br>";
