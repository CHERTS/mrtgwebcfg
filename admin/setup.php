...
$p = $_GET['p'];
$update_okey = $_GET['update_okey'];
$update_okey_err = $_GET['update_okey_err'];
...
if ($update_okey == "yes") {
	...
	$a_update_config .= "\$Deny_Save_Config_File = \"$Deny_Save_Config_File_\";\r\n";
	$a_update_config .= "\$Deny_Check_Update = \"$Deny_Check_Update_\";\r\n";
	$a_update_config .= "\n?>";
...
if($SQL_Type=="mysql") { $SQL_Type_Set[0]=""; $SQL_Type_Set[1]="selected"; }
if($SQL_Type=="postgres") { $SQL_Type_Set[0]="selected"; $SQL_Type_Set[1]=""; }
print "<tr bgcolor='#F0F0F0'><td align=right><b>$MRTGMsg[228]:</b></td><td><SELECT class='setup' name=\"SQL_Type_\"><option $SQL_Type_Set[0] value=\"postgres\">PostgreSQL<option $SQL_Type_Set[1] value=\"mysql\">MySQL</SELECT></td><td></td></tr>";
...
print "<tr bgcolor='#F0F0F0'><td align=right><b>$MRTGMsg[269]:</b></td><td><input class='setup' type=text name=Deny_Save_Config_File_ value=\"$Deny_Save_Config_File\" size=70></td><td></td></tr>";
print "<tr bgcolor='#F0F0F0'><td align=right><b>$MRTGMsg[270]:</b></td><td><input class='setup' type=text name=Deny_Check_Update_ value=\"$Deny_Check_Update\" size=70></td><td></td></tr>";

print "<tr bgcolor='#F0F0F0'><td colspan=3 align=center><input type='submit' name='update' class='submit_button' value='$MRTGMsg[43]'></td></tr></form></table>";
