...
print "<br><table width='100%' align=center cellpadding=2 cellspacing=1 bgcolor='#808080'><form methode='post' action='search.php'><tr bgcolor='#AABBCC' align=center><td colspan=2><b>$MRTGMsg[81]</b></td></tr>";
print "<tr align=center bgcolor='#F0F0F0'><td>".$MRTGMsg[94]."</td><td>";
print "<select name='search_id'>";
print "<option selected value='title'>$MRTGMsg[95]";
print "<option value='ip'>$MRTGMsg[96]";
print "</select></td></tr>";
print "<tr align=center bgcolor='#F0F0F0'><td width='30%'>$MRTGMsg[82]</td><td><input type='text' name='search_string' value=''></input></td></tr>";
print "<tr bgcolor='#F0F0F0' align=center><td colspan=2><input type=hidden name='search' value='set'><input type='submit' name='submit' class='submit_button' style='width:100px' value='$MRTGMsg[84]'></input></td></tr></form></table>";
