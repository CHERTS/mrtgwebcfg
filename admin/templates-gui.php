...
if ( isset($set_templates) || $set_templates == '' ) {
	...
	for ($i=1; $i<=$index_rows; $i++) {
		...
		if ( $rows == 1 ) {
			...
			if ($row[4] == 1) {
				...
				print "<td width=50%><table cellpadding=4 cellspacing=0 width=100%><tr><b>$row[1]</b></tr><tr>\n";
				print "<SELECT name='agent_".$row[3]."_".$row[4]."' onchange=\"change('set_".$row[3]."_".$row[4]."',this.value)\" style='color:black;border:1x solid black;background-color:#FFFFFF;font-size:12px;width: 100%'>\n";
				...
				print "</SELECT></tr><tr>$MRTGMsg[61]: $row[3] | $MRTGMsg[62]: $row[4] | <a href='' id='set_".$row[3]."_".$row[4]."' title='$MRTGMsg[177]'>$MRTGMsg[124]</a> | <a href='templates.php?sid=$row[5]&hid=$row[0]&gid=$gid&mode=hide' title='$TITLE_HIDE'>$STATUS_HIDE</a> | <a href='templates.php?sid=$row[5]&hid=$row[0]&gid=$gid&mode=delete' title='$MRTGMsg[179]'>$MRTGMsg[12]</a> | <a href='addrows.php?gid=$gid&addrows=$row[3]' title='$MRTGMsg[125]'>+</a>";
				print "</tr></table></td>\n";
				print "<td width=50%><table cellpadding=4 cellspacing=0 width=100%><tr><b>$MRTGMsg[122]</b></tr><tr>\n";
				print "<SELECT name='id_a_".$row[3]."' onchange=\"change('id_".$row[3]."',this.value)\" style='color:black;border:1x solid black;background-color:#FFFFFF;font-size:12px;width: 100%'>\n";
				print "<option selected value=''> </option>\n";
				print gui_select("-1", "templates.php?gid=$gid&row_set=$row[3]&column_set=".($row[4]+1)."&mode=add");
				print "</SELECT></tr><tr>$MRTGMsg[61]: $row[3] | $MRTGMsg[62]: ".($row[4]+1)." | <a href='' id='id_".$row[3]."' title='$MRTGMsg[180]'>$MRTGMsg[123]</a> | <a href='addrows.php?gid=$gid&addrows=$row[3]' title='$MRTGMsg[125]'>+</a>";
				print "</tr></table></td></tr>\n";
			} else {
				print "<tr bgcolor='#F0F0F0'>\n";
				print "<td width=50%><table cellpadding=4 cellspacing=0 width=100%><tr><b>$MRTGMsg[122]</b></tr><tr>\n";
				print "<SELECT name='id_b_".$row[3]."' onchange=\"change('id_".$row[3]."',this.value)\" style='color:black;border:1x solid black;background-color:#FFFFFF;font-size:12px;width: 100%'>";
				print "<option selected value=''> </option>\n";
				print gui_select("-1", "templates.php?gid=$gid&row_set=$row[3]&column_set=".($row[4]-1)."&mode=add");
				print "</SELECT></tr><tr>$MRTGMsg[61]: $row[3] | $MRTGMsg[62]: ".($row[4]-1)." | <a href='' id='id_".$row[3]."' title='$MRTGMsg[180]'>$MRTGMsg[123]</a> | <a href='addrows.php?gid=$gid&addrows=$row[3]' title='$MRTGMsg[125]'>+</a>";
				print "</tr></table></td>\n";
			...
			<table cellpadding=4 cellspacing=0 width=100%><tr><b>$row_1[1]</b></tr><tr>";
			print "<SELECT name='agent_".$row_1[3]."_".$row_1[4]."' onchange=\"change('set_".$row_1[3]."_".$row_1[4]."',this.value)\" style='color:black;border:1x solid black;background-color:#FFFFFF;font-size:12px;width: 100%'>";
			...
			print "</SELECT></tr><tr>$MRTGMsg[61]: $row_1[3] | $MRTGMsg[62]: $row_1[4] | <a href='' id='set_".$row_1[3]."_".$row_1[4]."' title='$MRTGMsg[177]'>$MRTGMsg[124]</a> | <a href='templates.php?sid=$row_1[5]&hid=$row_1[0]&gid=$gid&mode=hide' title='$TITLE_HIDE'>$STATUS_HIDE</a> | <a href='templates.php?sid=$row_1[5]&hid=$row_1[0]&gid=$gid&mode=delete' title='$MRTGMsg[179]'>$MRTGMsg[12]</a> | <a href='addrows.php?gid=$gid&addrows=$row_1[3]' title='$MRTGMsg[125]'>+</a>";
			print "</tr></table></td>";
			print "<td width=50%><table cellpadding=0 cellspacing=0 width=100%><tr><b>$row_2[1]</b></tr><tr>";
			print "<SELECT name='agent_".$row_2[3]."_".$row_2[4]."' onchange=\"change('set_".$row_2[3]."_".$row_2[4]."',this.value)\" style='color:black;border:1x solid black;background-color:#FFFFFF;font-size:12px;width: 100%'>";
			...
			print "</SELECT></tr><tr>$MRTGMsg[61]: $row_2[3] | $MRTGMsg[62]: $row_2[4] | <a href='' id='set_".$row_2[3]."_".$row_2[4]."' title='$MRTGMsg[177]'>$MRTGMsg[124]</a> | <a href='templates.php?sid=$row_2[5]&hid=$row_2[0]&gid=$gid&mode=hide' title='$TITLE_HIDE'>$STATUS_HIDE</a> | <a href='templates.php?sid=$row_2[5]&hid=$row_2[0]&gid=$gid&mode=delete' title='$MRTGMsg[179]'>$MRTGMsg[12]</a> | <a href='addrows.php?gid=$gid&addrows=$row_2[3]' title='$MRTGMsg[125]'>+</a>";
			print "</tr></table></td>";
		} else {
	...
	print "</table><br><div align=center><table cellpadding=0 cellspacing=5><tr align=center>\n";
	print "<td><form method=post ACTION='index.php'><input type=submit value='$MRTGViewMsg[1]' style='color:#0000FF;border:1x solid red;background-color:#EDEEEE;font-size:13px;width:170px'></form></td>\n";
	print "</tr></table></div>\n";
